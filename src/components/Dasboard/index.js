...
class Dashboard extends Component {
    state = { month: 3, list: [], searchInput: '', statisticsMonth: 3, statisticsData: {}, pieMonth: 3, pieData: {}, barMonth: 3, barData: {} }
    ...
    fetchList = async () => {
        ...
        this.setState({ list: jsonData.data })
    }
    ...
    fetchStatistics = async () => {
        ...
        const jsonData = await data.json()
        this.setState({ statisticsData: jsonData.data })
    }
    ...
    fetchPie = async () => {
        ...
        const jsonData = await data.json()
        this.setState({ pieData: jsonData.data })
    }
    ...
    fetchBar = async () => {
        ...
        const jsonData = await data.json()
        this.setState({ barData: jsonData.data })
    }
    ...
    render() {
        const { list, searchInput, statisticsData, statisticsMonth, pieMonth, pieData, barMonth, barData } = this.state
        return (
            <div className='main-cont'>
                <h1 className='head'>Transactions Dashboard</h1>

                <div className='chartsCont'>
                    <Statistics PassedFunction={this.updatestatisticsMonth} data={statisticsData} month={statisticsMonth} />
                    <Barchart PassedFunction={this.updateBarMonth} barData={barData} month={barMonth} />
                    <PieCharts PassedFunction={this.updatePieMonth} piedata={pieData} month={pieMonth} />
                </div>
